...
<head runat="server">
    <title>Residencias ocupadas</title>
    <meta charset="UTF-8">
        ...
        <nav class="navbar-user-top full-reset">
         ...
         <div class="container">
            <div class="page-header">
              <h1 class="all-tittles"> Arrendamiento Residencial <small>Detalles del Arquiler Realizados</small></h1>
            </div>
        </div>
        ...
        <div class="container-fluid"  style="margin: 50px 0;">
						<div class="row">
								<div class="col-xs-12 col-sm-4 col-md-3">
										<img src="assets/img/usere.png" alt="user" class="img-responsive center-box" style="max-width: 210px;">
								</div>
								<div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
										Bienvenido aqui podras ver todas las residencias ocupadas o alquiladas por un Estudiante.
								</div>
						</div>
				</div>
        				...
        				<div class="container-fluid" align="center">
        						...
        						<div class="container-flat-form">
        								<div class="title-flat-form title-flat-blue">Residencias Ocupadas</div>

        										<div class="row">
        											 <form id="form1" runat="server">
   
    <hr />
    <asp:GridView ID="gvImages" runat="server" AutoGenerateColumns="False" OnRowDataBound="OnRowDataBound" Width="947px">
        <Columns>
            <asp:BoundField DataField="id" HeaderText="#" />
            <asp:BoundField DataField="numeroresidencia" HeaderText="numero de residencia" />
            <asp:BoundField HeaderText="lugar" DataField="lugar" />
            <asp:BoundField HeaderText="Comodidad" DataField="cuartosala" />
            <asp:BoundField DataField="utilidades" HeaderText="utilidades" />
            <asp:BoundField DataField="cedula" HeaderText="cedula" />
            <asp:BoundField DataField="nombre" HeaderText="inquilino" />
             <asp:TemplateField HeaderText = "foto">
                <ItemTemplate>
                    <asp:Image ID="Image3" runat="server" Height="150" Width="100" />
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText = "sede">
                <ItemTemplate>
                    <asp:Image ID="Image1" runat="server" Height="150" Width="100" />
                </ItemTemplate>
            </asp:TemplateField>
             <asp:TemplateField HeaderText = "habitacion">
                <ItemTemplate>
                    <asp:Image ID="Image2" runat="server" Height="150" Width="100" />
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
